...
export function MonthView({
  ...
  const weekdays = useMemo(() => {
    return Array.from({ length: 7 }).map((_, i) => {
      return getArabicDayName(i, "abbreviated")
    })
  }, [])
          ...
          >
            {week.map((day, dayIndex) => {
              ...
              return (
                <div
                  key={day.toString()}
                  className="group border-border/70 data-outside-cell:bg-muted/25 data-outside-cell:text-muted-foreground/70 border-r border-b"
