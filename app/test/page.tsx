  ...
  return (
    <div className="space-y-8 p-24 ">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-2">Hover over and click these buttons to see the animations.</p>
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-2">Click the button to see the loading animation.</p>
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          <NeumorphButton intent="primary" loading={loading} onClick={handleClick}>
